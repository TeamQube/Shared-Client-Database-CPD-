<?php include("frontendheader.php"); ?>
    ...
    <div class="container">
		...
		<section class="my-3">
          <?php		
			 $result = mysqli_query($con,"Select * from internships order by id desc"); 
				...
				<div class="modal-dialog">
				  ...
				  <div class="modal-content">
					<div class="modal-header">
					  <h4 class="modal-title">Apply For This Internship</h4>
					</div>
						  <form action="internship.php" method="post" class="my-4">
							...
							<div class="row">
                           	...
                           	<div class="row">
								...
								<div class="col-lg-7 mx-2">
									<input type="text" class="form-control" readonly value="<?php echo $industry['title']; ?>" name="job" placeholder="Internship Title" required="true" autocomplete="off">
    ...
    if(isset($_POST["sub"]))
	{
			...
			$result=mysqli_query($con,$qurey);
				...
				foreach($result as $data);	
						...
						$name = $data['id'];
				$result = mysqli_query($con,"INSERT INTO stdapplyforjob(name,internship) values('$name','$job')");
