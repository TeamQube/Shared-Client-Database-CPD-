...
{
	$result = mysqli_query($con,"select * from internships WHERE id=".$_GET["id"]);
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><a href="employeeinternship.php" >Internships Project</a></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active"><a href="employeeinternship.php" >Internships Project</a></li>
                        </ol>
                    </div>
                </div>
            </div>
          								...
          								<div class="col-lg-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form action="employeeinternship-db.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                            
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Internship Title</label></div>
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="email-input" class=" form-control-label">Internship Description</label></div>
                                                            ...
                                                            <div class="row form-group">
                                                                    <div class="col col-md-3"><label for="file-input" class=" form-control-label">Internship Image</label></div>
