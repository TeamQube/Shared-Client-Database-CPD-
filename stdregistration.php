...
?>
    ...
    <div class="container-fluid text-center p-5 about-header">
        <h1 class="text-light">Student Sign Up</h1>
        <hr style="width: 5%;"/>
    </div>
    ...
    <div class="container contact">
            <div class="row">
                ...
                <div class="col-md-8">
				 ...
				 <?php }?>
                    <form action="stdregistration-db.php" method="post">
                        <div class="row">
                            <div class="col-lg-6">
                        ...
                        <div class="row">
                           <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
								<select id="scourse" name="scourse" class="form-control" style="font-size: 15px;" >
